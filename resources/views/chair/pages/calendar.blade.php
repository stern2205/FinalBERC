    ...
    <script>
        ...
        function makeEventCard(day, ev, isForModal = false) {
            ...
            if (isForModal) {
                ...
                item.innerHTML = `
                    ...
                    <div class="hidden expandable-content border-t border-gray-100 bg-[#FAFAFA] p-5">
                        ${ev.applicant ? `<p class="text-[12px] text-gray-700 mb-4"><strong class="text-gray-400 uppercase text-[10px] tracking-widest mr-2">Primary Researcher:</strong> <br>${ev.applicant}</p>` : ''}
                        ...
                        ${ev.appId ? `
                            <div class="mt-6 text-right">
                                <a href="/chair/history?openApp=${ev.appId}" class="inline-flex items-center justify-center px-5 py-2.5 bg-brand-red text-white text-[10px] font-bold uppercase tracking-widest rounded-lg hover:bg-red-700 transition-colors shadow-sm">
            ...
            // ==========================================
                ...
                if (ev.appId) wrapper.setAttribute('href', `/chair/history?openApp=${ev.appId}`);
