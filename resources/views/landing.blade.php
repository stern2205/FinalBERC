...
<head>
    ...
    .blue-gradient-bg {
        background: linear-gradient(135deg, #1f377a 0%, #152756 100%);
    }
    ...
    .slide-first {
        animation: fade-up-first 10s ease-in-out infinite;
    }

    .slide-second {
        animation: fade-up-second 10s ease-in-out infinite;
    }
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-full">
            ...
            <div class="flex items-center">
                <div class="relative w-20 sm:w-24 h-16 flex items-center">
                    <img src="{{ asset('logo/BERC.png') }}" alt="BSU Logo"
                ...
                <div class="flex flex-col justify-center ml-3 sm:ml-4 border-l-2 border-gray-200 pl-3 sm:pl-5 py-1">
                    <h1
                        class="text-[11px] sm:text-[15px] font-bold text-[#1f377a] leading-none tracking-tight uppercase">
                        Batangas State University - TNEU
                    </h1>
                    <h2
                        class="text-[9px] sm:text-[10px] font-bold text-red-600 tracking-[0.18em] uppercase mt-1 sm:mt-1.5">
            ...
            <!-- Mobile hamburger -->
            <button id="hamburger"
                class="md:hidden flex flex-col justify-center items-center gap-[5px] w-9 h-9 rounded border border-gray-200 bg-white"
            ...
            <div class="flex flex-col w-full max-w-3xl">
                ...
                <div class="relative h-[220px] sm:h-[240px] lg:h-[260px]">
                    ...
                    <div class="slide-second absolute inset-0 flex flex-col justify-center text-white">
                        <h1
                            class="text-2xl sm:text-4xl lg:text-5xl font-extrabold leading-[1.15] mb-2 sm:mb-3 tracking-tight">
                            BATANGAS STATE UNIVERSITY<br>– TNEU
                        </h1>
                        <h2
                            class="text-base sm:text-lg lg:text-xl font-semibold text-red-400 tracking-[0.18em] uppercase mb-3 sm:mb-5">
                            Ethics Review Committee
                        </h2>
            ...
            <div class="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed mb-6 sm:mb-8 text-sm sm:text-base">
                        The Batangas State University Ethics Review Committee (BERC) ensures that <strong>all
                            research</strong> involving human participants follows ethical standards and institutional
                        guidelines.
                    </p>
                    <ul class="space-y-3 sm:space-y-4 text-gray-700 font-medium text-sm sm:text-base">
                        <li class="flex items-center">
                            <span
                                class="w-5 h-5 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mr-3 text-xs shrink-0">✓</span>
                            Ethical Review
                        </li>
                        <li class="flex items-center">
                            <span
                ...
                <div class="grid grid-cols-3 gap-3 sm:gap-4 mt-8 lg:mt-0">
                    <div class="bg-white p-4 sm:p-6 rounded-xl shadow-xl text-center border-t-4 border-blue-600">
                        <div class="text-blue-600 mb-1 sm:mb-2 font-bold text-2xl sm:text-3xl">0</div>
                        <p class="text-[9px] sm:text-[10px] uppercase tracking-tighter text-gray-400 font-bold">Projects
                            Completed</p>
                    </div>
                    <div class="bg-white p-4 sm:p-6 rounded-xl shadow-xl text-center border-t-4 border-blue-600">
                        <div class="text-blue-600 mb-1 sm:mb-2 font-bold text-2xl sm:text-3xl">0%</div>
                        <p class="text-[9px] sm:text-[10px] uppercase tracking-tighter text-gray-400 font-bold">Approval
                            Rate</p>
                    </div>
                    <div class="bg-white p-4 sm:p-6 rounded-xl shadow-xl text-center border-t-4 border-blue-600">
                        <div class="text-blue-600 mb-1 sm:mb-2 font-bold text-2xl sm:text-3xl">0</div>
                        <p class="text-[9px] sm:text-[10px] uppercase tracking-tighter text-gray-400 font-bold">
                            Publications</p>
                    </div>
                </div>
            </div>
    ...
    <section id="berc-facts" class="py-16 sm:py-20 bg-gray-50 border-y border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-gray-500 mb-10 sm:mb-16 italic text-sm sm:text-base">What distinguishes BERC efficiency
                through ethics review process:</p>

            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
                <div class="bg-white p-5 sm:p-8 rounded-lg shadow-sm hover:shadow-md transition border border-gray-100">
                    <div
                        class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 rounded-lg mx-auto mb-4 sm:mb-6 flex items-center justify-center text-white">
                    ...
                    <p class="text-xs text-gray-500 leading-relaxed">Sign up to create your personal account on the BERC
                        Online System.</p>
                </div>
                <div class="bg-white p-5 sm:p-8 rounded-lg shadow-sm hover:shadow-md transition border border-gray-100">
                    <div
                        class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500 rounded-lg mx-auto mb-4 sm:mb-6 flex items-center justify-center text-white">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-xs text-gray-500 leading-relaxed">Fill out and upload the necessary research proposal
                        documents.</p>
                </div>
                <div class="bg-white p-5 sm:p-8 rounded-lg shadow-sm hover:shadow-md transition border border-gray-100">
                    <div
                        class="w-10 h-10 sm:w-12 sm:h-12 bg-sky-500 rounded-lg mx-auto mb-4 sm:mb-6 flex items-center justify-center text-white">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-xs text-gray-500 leading-relaxed">BERC conducts a thorough ethical review of your
                        research proposal.</p>
                </div>
                <div class="bg-white p-5 sm:p-8 rounded-lg shadow-sm hover:shadow-md transition border border-gray-100">
                    <div
                        class="w-10 h-10 sm:w-12 sm:h-12 bg-orange-500 rounded-lg mx-auto mb-4 sm:mb-6 flex items-center justify-center text-white">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                    </div>
                    <h3 class="font-bold text-gray-800 mb-1 sm:mb-2 text-sm sm:text-base">Receive Approval</h3>
                    <p class="text-xs text-gray-500 leading-relaxed">Receive feedback or approval and track your status
                        online.</p>
                </div>
            </div>

            <a href="#" class="mt-10 sm:mt-12 inline-block text-blue-600 font-semibold text-sm hover:underline">View
                Guidelines →</a>
        </div>
    </section>
    ...
    <section class="py-16 sm:py-20 lg:py-24 blue-gradient-bg text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div>
                    <h2 class="text-4xl sm:text-5xl md:text-6xl font-light tracking-tight mb-1 sm:mb-2 opacity-80">FIRST
                        TIME</h2>
                    <h2
                        class="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight mb-6 sm:mb-8 leading-none">
                        SUBMITTING</h2>
                    <p class="text-gray-300 mb-8 sm:mb-10 text-base sm:text-lg leading-relaxed">
                        You and your research team are welcome to submit proposals to BERC for ethics review. We are
                ...
                <!-- Stats panel -->
                <div
                    class="bg-blue-900/40 p-8 sm:p-12 rounded-2xl border border-blue-800 backdrop-blur-sm mt-4 lg:mt-0">
                    <div class="space-y-8 sm:space-y-12">
                        <div class="flex items-end justify-between border-b border-blue-800 pb-6">
                            ...
                            <p class="text-[10px] text-gray-400 max-w-[150px] text-right">Successfully completed with
                        ...
                        <div class="flex items-end justify-between border-b border-blue-800 pb-6">
                            ...
                            <p class="text-[10px] text-gray-400 max-w-[150px] text-right">Researchers hold positions
                                related to career goals.</p>
                        </div>
                        <div class="flex items-end justify-between">
                            ...
                            <p class="text-[10px] text-gray-400 max-w-[150px] text-right">Annual research projects
                                completed in 2024.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid sm:grid-cols-2 md:grid-cols-3 gap-10 sm:gap-12">
            <div>
                <div class="flex items-center space-x-3 mb-4 sm:mb-6">
                    <img src="{{ asset('logo/bsu_logo.png') }}" alt="Logo"
            ...
            <div class="sm:col-span-2 md:col-span-1">
                ...
                <p class="text-xs mb-2"><a href="mailto:berc@g.batstate-u.edu.ph"
                        class="hover:text-blue-400">berc@g.batstate-u.edu.ph</a></p>
                <p class="text-xs mb-2">Rizal Avenue Ext., Batangas City, Batangas, Philippines 4200</p>
                <p class="text-xs">(043) 425-0139 loc. 2121</p>
            </div>
        </div>
        <div
            class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-gray-800 mt-10 sm:mt-12 pt-6 sm:pt-8 text-center text-[10px]">
