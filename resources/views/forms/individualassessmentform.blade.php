...
<body>
    ...
    <div class="page">
        ...
        <div style="border: 1px solid black; padding: 10px; margin-bottom: 15px;">
            <div class="bold" style="margin-bottom: 10px;">Guide questions for reviewing the informed consent process and form</div>
            ...
            <div style="margin-bottom: 10px; display: flex; align-items: flex-end;">
                ...
                <div style="border-bottom: 1px solid black; flex-grow: 1; margin-left: 10px; min-height: 18px; padding-left: 6px;">
                    {{ ($assessmentForm->is_consent_necessary ?? '') === 'no' ? ($assessmentForm->no_consent_explanation ?? '') : '' }}
                </div>
            </div>

            <div>If YES, are the participants provided with sufficient information regarding:</div>
        </div>
