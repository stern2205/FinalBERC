    ...
    <script>
        ...
        function makeEventCard(day, ev, isForModal = false) {
                    ...
                    <div class="hidden expandable-content border-t border-gray-100 bg-[#FAFAFA] p-5">
                        ...
                        ${ev.appId ? `
                            <div class="mt-6 text-right">
                                <a href="/secretariat/history?openApp=${ev.appId}" class="inline-flex items-center justify-center px-5 py-2.5 bg-brand-red text-white text-[10px] font-bold uppercase tracking-widest rounded-lg hover:bg-red-700 transition-colors shadow-sm">
            ...
            // ==========================================
                ...
                if (ev.appId) wrapper.setAttribute('href', `/secretariat/history?openApp=${ev.appId}`);
