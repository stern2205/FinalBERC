...
<head>
    ...
    <title>Forget Password - BatSU</title>
    ...
    <div class="page-wrapper">
        <div class="auth-card">
            ...
            <div class="left-panel">
                <div class="relative z-10 flex flex-col items-center text-center">
                    ...
                    <p style="font-size:0.8rem; color:rgba(255,255,255,0.8); font-weight:400; max-width:220px; line-height:1.8; letter-spacing:0.02em;">
                        Request a reset code to recover access to your BERC account securely.
                    </p>
            ...
            <div class="right-panel">
                ...
                <form action="{{ route('password.sendCode') }}" method="POST" class="space-y-4">
                    @csrf
                    ...
                    <div style="display:flex; align-items:center; justify-content:space-between; gap:1rem; padding-top:0.75rem; flex-wrap:wrap;">
                        <div style="font-size:0.78rem; color:rgba(255,255,255,0.82);">
                            ...
                            <a href="{{ route('login.form') }}"
                               style="color:#ff9b9b; text-decoration:none; font-weight:600;">Sign In</a>
                        </div>

                        <button type="submit" class="submit-btn">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" style="transform: rotate(45deg);">
