...
<head>
    ...
    <title>Verify Account - BatStateU</title>
    ...
    <div class="page-wrapper">
        <div class="auth-card">
            ...
            <div class="left-panel">
                <div class="relative z-10 flex flex-col items-center text-center">
                    ...
                    <p style="font-size:0.8rem; color:rgba(255,255,255,0.8); font-weight:400; max-width:220px; line-height:1.8; letter-spacing:0.02em;">
                        Verify your account using the code sent to your registered email address.
                    </p>
            ...
            <div class="right-panel">
                ...
                @if(session('success'))
                    <div style="font-size:0.78rem; color:#dcfce7; margin-bottom:1rem; background:rgba(34,197,94,0.16); padding:0.75rem 0.9rem; border-left:3px solid #4ade80; font-weight:500;">
                        {{ session('success') }}
                    </div>
                @endif

                <form action="{{ route('acctv.verify') }}" method="POST" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="input-row">
                            <input type="text"
                                   ...
                                   class="form-input"
                                   style="font-family:'Montserrat',sans-serif; font-size:1rem; letter-spacing:0.35em; font-weight:700;">
                    ...
                    <div style="display:flex; align-items:center; justify-content:space-between; gap:1rem; padding-top:0.75rem; flex-wrap:wrap;">
                        <div style="font-size:0.78rem; color:rgba(255,255,255,0.82);">
                            ...
                            <a href="{{ route('signup.form') }}"
                               style="color:#ff9b9b; text-decoration:none; font-weight:600;">Go back</a>
                        </div>
