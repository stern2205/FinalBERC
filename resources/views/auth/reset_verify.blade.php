...
<head>
    ...
    <title>Verify Reset Code - BERC</title>
    ...
    <div class="page-wrapper">
        <div class="auth-card">
            ...
            <div class="left-panel">
                <div class="relative z-10 flex flex-col items-center text-center">
                    ...
                    <p style="font-size:0.8rem; color:rgba(255,255,255,0.8); font-weight:400; max-width:220px; line-height:1.8; letter-spacing:0.02em;">
                        Enter the reset code sent to your email to continue changing your password securely.
                    </p>

                    <a href="{{ route('forget.form') }}"
            ...
            <div class="right-panel">
                ...
                <p style="font-size:0.8rem; color:rgba(255,255,255,0.82); margin-bottom:0.35rem; font-weight:400; letter-spacing:0.03em;">
                    Please enter the 6-digit code sent to
                </p>
                <p style="font-size:0.84rem; color:#ffffff; margin-bottom:2rem; font-weight:700; letter-spacing:0.02em;">
                ...
                <form action="{{ route('password.verifyCode') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        @error('code')
                            <p style="font-size:0.75rem; color:#fca5a5; font-weight:700; margin-top:0.6rem;">
                                {{ $message }}
                            </p>
                        @enderror
                    </div>

                    <div style="display:flex; align-items:center; justify-content:space-between; gap:1rem; padding-top:0.75rem; flex-wrap:wrap;">
                        <div style="font-size:0.78rem; color:rgba(255,255,255,0.82);">
                            Didn’t receive a code?
                            <a href="{{ route('forget.form') }}"
                               style="color:#ff9b9b; text-decoration:none; font-weight:600;">Resend</a>
                        </div>
